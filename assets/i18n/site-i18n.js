(() => {
  ...
  const basePhrases = {
    ...
    "Divine Light Chant Sphere": { id: "Chant Sphere Cahaya Ilahi", zh: "神圣之光 Chant Sphere", ru: "Сфера Божественного света" },
    "Unity Whole Chant Sphere": { id: "Chant Sphere Kesatuan Utuh", zh: "合一完整 Chant Sphere", ru: "Сфера цельного единства" },
    "Spirit Protection Chant Sphere": { id: "Chant Sphere Perlindungan Roh", zh: "灵性保护 Chant Sphere", ru: "Сфера духовной защиты" },
    "Good Decree Chant Sphere": { id: "Chant Sphere Keputusan Baik", zh: "良善 decree Chant Sphere", ru: "Сфера доброго решения" },
    "Success Path Chant Sphere": { id: "Chant Sphere Jalan Sukses", zh: "成功之路 Chant Sphere", ru: "Сфера пути успеха" },
