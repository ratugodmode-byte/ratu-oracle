...
function schemas({ title, description, canonical, productsForPage = products, breadcrumbName, faqItems = faq, type = "CollectionPage", keywords = [] }) {
  return [
    ...
    { "@context": "https://schema.org", "@type": type, name: title, url: abs(canonical), description, ...(keywords.length ? { keywords: keywords.join(", ") } : {}) },
...
const gandharaKeywords = ["Gandhara Buddha head", "Gandhara Buddha head for sale", "Gandharan Buddha head", "Gandhara art", "Gandhara sculpture", "Greek Buddhist art", "Greco Buddhist Buddha head", "Buddhist head sculpture", "Buddha head statue", "Buddha head decor", "museum replica Buddha head", "museum reproduction Buddha head", "Gandhara replica Buddha", "Gandhara style Buddha", "Buddhist antiquities style", "ancient Buddhist art replica", "meditation decor", "spiritual art object", "sacred art object", "clarity talisman", "mindfulness object", "Buddhist collectible", "Himalayan art", "Indian Buddhist art", "Southeast Asian Buddhist art", "antiquities inspired decor", "Buddha head study piece", "museum grade reproduction", "schist style Buddha head", "stucco style Buddha head", "Avalokiteshvara", "Avalokitesvara", "Gandhara", "Gandharan Art", "Bodhisattva of Compassion", "Buddhist Sculpture", "Ancient Buddhist Art", "Meditation Statue", "Spiritual Decor", "Museum Replica", "Sacred Art", "Historical Sculpture", "Mahayana Buddhism", "Silk Road Art", "Compassion Symbol", "Home Altar", "Inner Peace", "Mindfulness", "Wellness Decor", "Asian Antiquities", "Sotheby's Asian art reference", "Sotheby's Buddhist sculpture reference", "Sothebys Buddhist art reference"];
gandhara.keywords = gandharaKeywords;
